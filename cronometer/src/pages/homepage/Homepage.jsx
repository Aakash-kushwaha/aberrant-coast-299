    ...
    >
     ...
     <Navbar></Navbar>
      ...
      <Box m={"30px auto"}>
        ...
        >
          <VStack spacing={"2%"}>
            <Heading color="gray.700" fontSize={{ base: 22, md: 30, lg: 30 }}>
              We are Canadian
            </Heading>
            <Text
              lineHeight={"2rem"}
              fontSize={{ base: 16, md: 25, lg: 25 }}
              fontWeight="medium"
            >
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Box>
            <Heading fontSize={{ base: "20px", lg: "50px", md: "50px" }}>
              Eat smarter.
            </Heading>
            <Heading fontSize={{ base: "20px", lg: "50px", md: "50px" }}>
              Live better.
          ...
          <Text
            lineHeight={"2.5rem"}
            fontSize={{ base: 18, sm: 18, lg: 30, md: 30 }}
          >
...
function SecoundBox() {
  return (
    <>
      <VStack w={"70%"} m="50px auto" justify={"center"} align="center">
        <Box>
    ...
    <>
      ...
      >
        <Flex
          ...
          gap="20px"
        >
          <Heading fontSize={{ base: 20, md: 26, lg: 30 }}>
        ...
        >
          ...
          >
            ...
            />
            <Heading fontSize={{ base: 16, md: 20, lg: 20 }}>
      ...
      >
        ...
        >
          <Box w={"50%"} textAlign="center" lineHeight="2rem">
            <Heading color="gray.600" fontSize={{ base: 20, md: 25, lg: 30 }}>
